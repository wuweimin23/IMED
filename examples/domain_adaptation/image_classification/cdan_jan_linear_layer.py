...
from dalib.adaptation.cdan_ensemble import ConditionalDomainAdversarialLoss,Head,Combination_Linear
...
def main(args: argparse.Namespace):
    ...
    combination = Combination_Linear(args.bottleneck_dim, num_classes).to(device)
