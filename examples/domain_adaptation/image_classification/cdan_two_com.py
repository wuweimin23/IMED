...
from dalib.adaptation.cdan_ensemble import ConditionalDomainAdversarialLoss,Head,Combination_Korn
...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.epochs):
        # train for one epoch
        train(train_source_iter, train_target_iter, classifier_cdan1,classifier_cdan2, head, head_true,combination, domain_adv_cdan1, domain_adv_cdan2, domain_adv_com,optimizer_cdan1,
              lr_scheduler_cdan1, optimizer_cdan2,lr_scheduler_cdan2, optimizer_head, lr_scheduler_head,ad_optimizer3, optimizer_discri, lr_scheduler_ad3, lr_scheduler_discri , mcc_loss , W, epoch, args)

        # evaluate on validation set
        acc1 = utils.validate(val_loader, classifier_cdan1,classifier_cdan2, head,head_true,combination,num_classes,classifier_feature_dim, W,args, device)
    ...
    for epoch in range(args.distill_epochs):
        train_student(train_source_iter, train_target_iter, classifier_cdan1,classifier_cdan2, head, head_true,combination, student_model, student_head, optimizer_student, lr_scheduler_student, W, epoch, args)
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator, model1: ImageClassifier1, model2: ImageClassifier1,
          model_head:Head,model_head_true:Head, model_combination:Combination_Korn ,domain_adv1: ConditionalDomainAdversarialLoss, domain_adv2: ConditionalDomainAdversarialLoss, domain_adv_com,optimizer_cdan: SGD,
          lr_scheduler_cdan: LambdaLR, optimizer_jan: SGD,
