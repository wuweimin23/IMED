...
from dalib.adaptation.cdan_ensemble import ConditionalDomainAdversarialLoss,Head,Combination_Korn_3
...
def main(args: argparse.Namespace):
    ...
    combination = Combination_Korn_3(args.bottleneck_dim, num_classes).to(device)
