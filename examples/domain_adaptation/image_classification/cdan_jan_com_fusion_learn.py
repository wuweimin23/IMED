...
from dalib.adaptation.cdan_ensemble import ConditionalDomainAdversarialLoss,Head,Combination_Korn_learn
...
def main(args: argparse.Namespace):
    ...
    combination = Combination_Korn_learn(args.bottleneck_dim, num_classes).to(device)
